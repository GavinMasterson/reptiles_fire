...
Twenty-one species is barely more than half of the 40 species that might have been present in the reserve, so how well did we do?
...
Reptiles do not have to be active every day like mammals, which means that they are unlikely to encounter the trap arrays on a daily basis. 
...
This means that six of the 25 detections of this species (24 %) would be reduced to two detections using a 'detection per site per day' approach.
